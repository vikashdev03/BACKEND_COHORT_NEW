...
/* 
* POST /api/post/createpost [ protected jsike pass token hai Wohi acces kr srkta hai ]
* - req.body  = ( caption , imageFile
*/
postRouter.post("/createost" , upload.single("image"),identifyUser, postController.CreatePostController)


/** 
 * GET /api/post/allUserPost [protected]
 */
postRouter.get("/allUserPost", identifyUser  ,postController.getAllUserPostController)


/*
 * GET /api/posts/OnePostDetails/:Postid
